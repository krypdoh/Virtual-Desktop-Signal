...
I_Icon = icons\icons8_keycap1.ico
...
;
; This function puts an icon with currentdesktop # in taskbar tray
;
displayIconNumber()
{
 global CurrentDesktop, DesktopCount, ix
 ;--http://www.autohotkey.com/board/topic/121982-how-to-give-your-scripts-unique-icons-in-the-windows-tray/
 ; set icon 1-10
 if (%CurrentDesktop% < 11) {
   I_Icon = icons\icons8_keycap%CurrentDesktop%.ico
  }
 ; set icon to * since greater than 10
 else {
   I_Icon = icons\icons8_keycapasterisk.ico
  }
...
displayIconNumber:
  ...
  CurrentDesktop := floor(InStr(all,cur) / strlen(cur))
  displayIconNumber()
return
